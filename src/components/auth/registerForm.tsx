              ...
              <FormItem>
                ...
                <FormControl>
                  <Textarea
                    ...
                    className="border-border/50  bg-background/80 glass-effect rounded-[5px] border-[2px] ring-0 focus:ring-0 placeholder:text-white text-white   focus:border-purple-900 resize-none focus-visible:ring-0"
                  />
                </FormControl>
                <FormMessage />
              </FormItem>
