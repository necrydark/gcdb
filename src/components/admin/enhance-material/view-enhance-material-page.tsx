"use client";
import { HolyRelic, Material, RelicEnhanceMaterial } from "@prisma/client";
...
interface MaterialsInterface {
  relicMaterials?: RelicEnhanceMaterial & {
    holyRelics: HolyRelic[];
  };
}

export default function ViewEnhanceMaterialPage({
  relicMaterials,
}: MaterialsInterface) {
  ...
  const handleDelete = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        title: "Enhance Material deleted",
        description: "The enhance material has been successfully deleted.",
      });
            ...
            <DialogContent className="bg-purple-300 dark:bg-purple-700">
              <DialogHeader>
                <DialogTitle className="text-white">
                  Delete Enhance Material
                </DialogTitle>
                <DialogDescription className="text-gray-500 dark:text-gray-300">
                  Are you sure you want to delete this enhance material? This action
                  cannot be undone.
                </DialogDescription>
              </DialogHeader>
              <div className="py-4">
                <p className="text-white">
                  You are about to delete the enhance material
                ...
                {relicMaterials?.holyRelics &&
                  relicMaterials.holyRelics.length > 0 && (
                    <p className="mr-2 text-destructive">
                      Warning: This material is used by {length}{" "}
                      relics.
                    </p>
                  )}
              </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card className="bg-purple-500 dark:bg-purple-900 border-purple-300 dark:border-purple-800">
          <CardHeader className="pb-2">
            <CardTitle className="text-base">Enhance Material Information</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col items-center mb-4">
              <div className="rounded-md overflow-hidden mb-4">
                <Image
                  ...
                  alt={relicMaterials?.name || "Enhance Material"}
                  width={50}
                  height={50}
        ...
        <Card className="bg-purple-500 dark:bg-purple-900 border-purple-300 dark:border-purple-800">
          <CardHeader className="pb-2">
            ...
            <CardDescription>
              This enhance material is used in {length} holy relics.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              {relicMaterials?.holyRelics.map((relic:any ) => (
                <div
                  key={relic.id}
