...
import { updateIngredient } from "@/src/actions/food";

interface IngredientEdit {
    ingredient: Ingredient;
}

const EditIngredientForm = ({ ingredient}: IngredientEdit) => {
        ...
        Ingredient Information
          ...
          <CardContent className="space-y-4">
            ...
            />
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Ingredient Location</FormLabel>
                  <FormControl>
                    <Input
                      {...field}
          ...
          {/* <FormError message={error} />
              ...
              >
                <Link href={"/dashboard/ingredients"}>Cancel</Link>
              </Button>
              <Button
                type="submit"
className="dark:hover:bg-purple-950 border-purple-900 bg-purple-400 rounded-[5px] hover:bg-purple-600 border-[2px] flex flex-row items-center text-white  hover:text-white dark:bg-purple-700 transition-all duration-250"              >
