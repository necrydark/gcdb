                        ...
                        <div>
                            {skillFields.map((skill, skillIndex) => (
                                <div key={skill.id}>
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input {...field} placeholder="Japanese Skill Name" />
                                                    </FormControl>
                                                </FormItem>
                                            )}
                                        />
                                    ...
                                    <h5 className="text-2xl leading-tight font-bold py-3">Skill Ranks</h5>
                                    <div className="grid md:grid-cols-3 grid-cols-1 gap-5">
                                        {[0, 1, 2].map((rankIndex) => (
                                                ...
                                                <FormField
                                                    ...
                                                    render={({ field }) => (
                                                        <FormItem>
                                                            ...
                                                            <FormControl>
                                                                <Input {...field} type="number" placeholder="Rank" />
                                                            </FormControl>
                                                        </FormItem>
                                                    )}
                                                />
                                                <FormField
                                                    ...
                                                    render={({ field }) => (
                                                        <FormItem>
                                                            ...
                                                            <FormControl>
                                                                <Input {...field} placeholder="Rank Description" />
                                                            </FormControl>
                                                        </FormItem>
                                                    )}
                                                />
                                    ...
                                    <Button
                                        ...
                                        className="mt-2"
                                        onClick={() => {
                                            const newRank = { rank: skillFields[skillIndex].skillRanks.length + 1, description: "", type: "" };
                                            form.setValue(`skills.${skillIndex}.skillRanks`, [...skillFields[skillIndex].skillRanks, newRank]);
                                        }}
                                    >
                                        Add Rank
                                    </Button>
                            ...
                            <Button
                                ...
                                className="mt-2"
                                onClick={() => {
                                    const newSkill = { name: "", jpName: "", imageUrl: "", skillRanks: [{ rank: 1, description: "", type: "" }] };
                                    form.setValue('skills', [...skillFields, newSkill]);
                                }}
                            >
                                Add Skill
                            </Button>
