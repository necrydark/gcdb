      ...
      skills: [
        {
          characterId: undefined,
          // characterUltimate: {
          //   name: "Ultimate Skill 1",
          //   jpName: "Skill 1",
          //   imageUrl: undefined,
          //   description: undefined,
          //   ultimateId: 1,
          // },
          characterSkill: Array(2).fill({
            name: undefined,
            jpName: undefined,
            imageUrl: undefined,
            characterSkillsId: 1,
            skillRank: Array(3).fill({
              description: undefined,
              type: undefined,
              characterSkillId: 1,
            }),
            ...
            <div>
              {skillFields.map((skill, skillIndex) => (
                <div key={skill.id}>
                  <FormField
                    control={form.control}
                    name={`skills.${skillIndex}.characterId`}
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Character ID</FormLabel>
                        <FormControl>
                  ...
                  <div className="grid md:grid-cols-2 grid-cols-1 gap-5">
                    {[0, 1].map((characterSkillIndex) => (
                      <div
                        className="flex flex-col gap-4"
                        key={characterSkillIndex}
                      >
                        <h5>Character Skill {characterSkillIndex + 1}</h5>
                        <FormField
                          control={form.control}
                          name={`skills.${skillIndex}.characterSkill.${characterSkillIndex}.name`}
                          render={({ field }) => (
                            <FormItem>
                        ...
                        <FormField
                          control={form.control}
                          name={`skills.${skillIndex}.characterSkill.${characterSkillIndex}.jpName`}
                          render={({ field }) => (
                            <FormItem>
                        ...
                        <FormField
                          control={form.control}
                          name={`skills.${skillIndex}.characterSkill.${characterSkillIndex}.imageUrl`}
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel>Image URL</FormLabel>
                              <FormControl>
                        ...
                        <FormField
                          control={form.control}
                          name={`skills.${skillIndex}.characterSkill.${characterSkillIndex}.characterSkillsId`}
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel>Character Skills ID</FormLabel>
                              <FormControl>
                                <Input
                                  {...field}
                                  type="text"
                                  placeholder="Character Skills ID"
                                />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                  ...
                  <div className="grid md:grid-cols-3 grid-cols-1 gap-5">
                    {[0, 1, 2, 3, 4, 5].map((rankIndex) => (
                      <div className="flex flex-col gap-4" key={rankIndex}>
                        <h5>Skill Rank {rankIndex + 1}</h5>
                        <FormField
                          control={form.control}
                          name={`skills.${skillIndex}.skillRank.${rankIndex}.description`}
                          render={({ field }) => (
                            <FormItem>
                        ...
                        <FormField
                          control={form.control}
                          name={`skills.${skillIndex}.skillRank.${rankIndex}.type`}
                          render={({ field }) => (
                            <FormItem>
                        ...
                        <FormField
                          control={form.control}
                          name={`skills.${skillIndex}.skillRank.${rankIndex}.characterSkillId`}
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel>Character Skill ID</FormLabel>
                              <FormControl>
                                <Input
                                  {...field}
                                  type="text"
                                  placeholder="Character Skill ID"
                                />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
