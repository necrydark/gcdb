...
function Footer() {
  return (
    <footer className="bg-purple-700 dark:bg-purple-950 transition-all duration-300">
      <div className="mx-auto w-full">
        ...
        <div className="px-4 py-6 bg-purple-600 dark:bg-purple-950 border-t-[1px] border-t-divider transition-all duration-300 flex items-center justify-center md:flex-row flex-col md:justify-between">
          <span className="text-md md:text-left text-center text-white ">
          ...
          <div className="flex mt-4 md:mt-0 space-x-5 justify-center rtl:space-x-reverse">
            <Link
              ...
              target="_blank"
              className=" transition-all duration-300 text-white hover:text-white/70"
            >
