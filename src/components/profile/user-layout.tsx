...
const UserLayout: React.FC<Props> = ({ user, children }: Props) => {
  const colour =
    (user?.profileColor as ProfileColour) || "DEFAULT".toLocaleLowerCase();
  ...
  const getGradientColours = (gradient: string) => {
    const gradientColours: Record<string, string> = {
      purple:
        "from-purple-300 via-purple-400/60 to-purple-600 dark:from-purple-500/30 dark:via-purple-700/60 dark:to-purple-900",
      ...
      green:
        "from-green-300 via-green-400/60 to-green-600 dark:from-green-500/30 dark:via-green-700/60 dark:to-green-900",
      yellow:
        "from-yellow-300 via-yellow-400/60 to-yellow-600 dark:from-yellow-500/30 dark:via-yellow-700/60 dark:to-yellow-900",
      cyan: "from-cyan-300 via-cyan-400/60 to-cyan-600 dark:from-cyan-500/30 dark:via-cyan-700/60 dark:to-cyan-900",
      orange:
        "from-orange-300 via-orange-400/60 to-orange-600 dark:from-orange-500/30 dark:via-orange-700/60 dark:to-orange-900",
      default: "gradient-mesh",
    };
    return gradientColours[gradient] || "gradient-mesh";
  };
