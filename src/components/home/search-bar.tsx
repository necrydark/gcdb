...
export default function CommandSearch() {
  ...
  return (
    <>
      ...
      >
        <div className="absolute inset-0 rounded-[5px] bg-purple-500/10 pointer-events-none" />
        <span className="hidden lg:inline-flex text-black dark:text-white">
          Search characters, users...
        </span>
      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        <Command
          className="rounded-[5px] text-white bg-purple-500/10 glass-effect"
          shouldFilter={false}
        >
          <CommandInput
