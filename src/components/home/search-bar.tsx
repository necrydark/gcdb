...
export default function CommandSearch() {
  ...
  return (
    <>
      <Button 
        variant="outline" 
        className="relative w-full justify-start text-sm text-gray-500 dark:text-gray-300 rounded-[5px] bg-purple-500 dark:bg-purple-700 sm:pr-12"
        onClick={() => setOpen(true)}
      >
        <span className="hidden lg:inline-flex">Search characters, users...</span>
        <span className="inline-flex lg:hidden">Search...</span>
        <kbd className="pointer-events-none absolute right-1.5 top-[10px] hidden h-5 select-none items-center gap-1 rounded-[5px] bg-purple-600 dark:bg-purple-950 px-1.5 font-mono text-xs font-medium opacity-100 sm:flex">
