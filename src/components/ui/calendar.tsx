...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      components={{
        IconLeft: ({ ...props }) => <ChevronLeft className="h-4 w-4 hover:bg-purple-700 dark:hover:bg-purple-900" />,
        IconRight: ({ ...props }) => <ChevronRight className="h-4 w-4 hover:bg-purple-700 dark:hover:bg-purple-900" />,
      }}
      {...props}
    />
  )
