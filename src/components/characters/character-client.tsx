...
import { Attribute, CrossoverType, Game, Race, Rarity } from "@prisma/client";
...
export default function CharacterClient({
  ...
  return (
    <div className="transition-all min-h-screen duration-300 pb-[7rem] pt-[5rem] ">
      <div className="container mx-auto p-4 max-w-7xl">
        ...
        <div className="dark:bg-purple-900 bg-purple-800 shadow-md p-4 rounded-[5px] mb-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4 mb-4">
            <div className="lg:col-span-2">
              <Input
                ...
                className="w-full dark:bg-purple-800 bg-purple-900 border-0 h-10 placeholder:text-white rounded-[5px] focus-visible:border-purple-700 focus:ring-purple-700 dark:focus:ring-purple-950 text-white"
              />
            </div>

            <Select value={attribute} onValueChange={setAttribute}>
              <SelectTrigger className="dark:bg-purple-800 bg-purple-900 text-white h-full  border-0 rounded-[5px]">
                <SelectValue placeholder="Attribute" />
              </SelectTrigger>
              <SelectContent className="dark:bg-purple-800 bg-purple-900 text-white border-0 rounded-[5px]">
                {attributes.map((attr) => (
                  <SelectItem
                    key={attr}
                    value={attr}
                    className="rounded-[5px] focus:bg-purple-800 dark:focus:bg-purple-900"
                  >
                    {attr}
                  </SelectItem>
                ))}
          ...
          <div className="flex justify-end">
            <Button
              ...
              className="dark:bg-purple-800 bg-purple-900 hover:text-white dark:hover:bg-purple-800/70 hover:bg-purple-900/70 border-0 rounded-[5px]"
            >
              Reset Filters
            </Button>
          </div>
        ...
        <div className="mb-4 text-sm text-white">
          Showing {filteredCharacters.length > 0 ? startIndex + 1 : 0}-
          {Math.min(endIndex, filteredCharacters.length)} of{" "}
                ...
                {currentCharacters.map((character) => (
                  <CharacterCard
                    ...
                    isCollected={
                      ...
                      Array.isArray(character.collection)
                        ? character.collection.some(
                ...
                <PaginationPrevious
                  ...
                  className={
                    currentPage === 1
                      ...
                      : "text-white dark:border-purple-400 hover:bg-purple-800"
                  }
                />
              </PaginationItem>
