...
import { ChevronDown, ChevronRight, Mail, MessageSquare, Search } from "lucide-react"
...
answer: React.ReactNode
    ...
    return (
        <div className="  rounded-[5px] mb-4">
            ...
            variant={"purple"}
            className="w-full flex justify-between items-center p-4 text-left rounded-[5px] font-medium focus:outline-none">
                <span>{question}</span>
...
const generalFAQs = [
    {
      ...
      answer: (
        <>
          <p>
            This is a comprehensive database for the game, providing detailed information about characters, holy relics,
            events, and more. Our goal is to be the most accurate and up-to-date resource for players.
          </p>
          <p>
            The database is community-driven, with contributions from players around the world who help maintain and
            expand our collection of information.
          </p>
        </>
      ),
    },
    ...
    {
      question: "Can I use the information from this database on my own website or videos?",
      answer: (
        <>
          <p>
            Yes, you are welcome to use information from our database for your own content, but we ask that you credit our
            website as the source. Please include a link back to our site when sharing our information.
          </p>
          <p>
            For extensive use of our data or API access, please contact us through the form at the bottom of this page.
          </p>
        </>
      ),
    },
  ...
  const accountFAQs = [
    ...
    },
    {
      ...
      answer: (
        <>
          <p>
            To create an account, click on the &quot;Sign Up&quot; button in the top right corner of any page. You&apos;ll need to
            provide:
          </p>
          <ul>
          ...
          <p>
            After submitting the form, you&apos;ll receive a verification email. Click the link in the email to activate your
            account.
          </p>
        </>
      ),
  ...
  const contributionFAQs = [
    {
      ...
      answer: (
        <>
          ...
          <ul>
            <li>Add missing information for characters, holy relics, or events</li>
          ...
          <p>
            To start contributing, create an account and visit our <Link href="/contribute">Contribution Guide</Link> for
    ...
    },
    {
      ...
      answer: (
        <>
          <p>Yes, we have specific guidelines to maintain quality and consistency across the database:</p>
          <ul>
            <li>All information must be accurate and verifiable in-game</li>
            <li>Follow our formatting and style guide for consistency</li>
            <li>Do not copy content directly from other sources without permission</li>
            <li>Be respectful and collaborative when working with other contributors</li>
          </ul>
          <p>
            For complete guidelines, please review our <Link href="/contribute/guidelines">Contribution Guidelines</Link>.
          </p>
        </>
      ),
    },
  ...
  const gameFAQs = [
      ...
      answer: (
        <>
          ...
          <ul>
            ...
            <li>
              <strong>PC:</strong> Available through the official website or specific game launchers
            </li>
          </ul>
          <p>
            For direct links, please visit the <Link href="/download">Download Page</Link>.
          </p>
        </>
      ),
    },
    ...
    {
      question: "I'm having technical issues with the game. Where can I get help?",
      answer:
                ...
                <div className="container mx-auto max-w-4xl">
                    {searchQuery && (
                        <div className="mb-6">
                            <p className="text-gray-300">
                                {totalFilteredLength} {totalFilteredLength === 1 ? "result" : "results"} for {searchQuery}
                            </p>
                            {totalFilteredLength === 0 && (
                                <div className="mt-4 p-4 bg-muted rounded-lg text-center">
                                    <p className="mb-2 font-medium">No FAQs match your search</p>
                                    <p className="text-gray-300">Try different keywords or check our contact section below</p>
                                </div>
                            )}
                        </div>
                    )}
                    ...
                    <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                        ...
                        <TabsContent value="general" className="space-y-6">
                            ...
                            )) : !searchQuery && <p className="text-muted-foreground">
                        ...
                        <TabsContent value="contribution" className="space-y-6">
                            <h2 className="text-2xl font-bold mb-4">Contribution Questions</h2>
              ...
              <CardFooter>
                <Button  className="w-full rounded-[5px] bg-purple-700 hover:opacity-75 dark:bg-purple-950 text-white" asChild>
                  <Link href="/contribute/characters">
                    Character Contribution Guide <ChevronRight className="ml-2 h-4 w-4" />
                  </Link>
                </Button>
              </CardFooter>
            </Card>
        ...
        <div className="container mx-auto max-w-4xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
              ...
              <CardContent>
                ...
                <Button  className="w-full rounded-[5px] bg-purple-700 hover:opacity-75 dark:bg-purple-950 text-white" asChild>
                  <a href="https://discord.gg/gamedatabase" target="_blank" rel="noopener noreferrer">
                    Join Discord
                  </a>
                </Button>
              </CardContent>
