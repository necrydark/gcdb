  ...
  try {
    const character = await db.character.findUnique({
      ...
      select: {
        ...
        holyRelic: {
          // If you need details of the holy relic
          select: {
            id: true,
            name: true,
            imageUrl: true,
            ...
            materials: {
              select: {
                id: true,
                name: true,
                imageUrl: true, // Select material fields
              },
            },
            enhanceMaterials: {
              select: {
  ...
  return (
    <div className="p-10 pt-[7rem] container mx-auto max-w-6xl ">
      ...
      <CharacterHeader
        character={character}
        isCollected={
          user && character.collection && Array.isArray(character.collection)
      ...
      {(user?.role === "OWNER" ||
        ...
        <div className="my-4 flex flex-row gap-4">
          <Button
            className="rounded-[5px] bg-purple-500 hover:bg-purple-600 dark:bg-purple-800 text-white dark:hover:bg-purple-900"
            asChild
          >
      ...
      <div className="mt-6 space-y-6">
        {comments?.map((comment: any, idx: number) => (
          <Card
            className="bg-purple-400 px-2 dark:bg-purple-900 text-white rounded-[5px] dark:border-purple-400"
            key={idx}
          >
            ...
            <CardContent>
              <div className="flex flex-row items-center justify-between">
                ...
                <p className="text-sm text-white dark:text-muted-foreground mt-2"></p>
              </div>
            </CardContent>
          </Card>
        ))}
