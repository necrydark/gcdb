...
const AdminMaterialsPage = async () => {
  ...
  return (
    <div className=" px-10 container flex flex-col gap-6 mx-auto py-4">
      ...
      <div>
      <h1 className="text-2xl font-bold tracking-tight text-white">Enhance Materials</h1>
      <p className="text-gray-500 dark:text-gray-300">Manage your inventory of enhance materials and resources</p>
        </div>
        ...
        <Link href={"/dashboard/enhance-materials/new"} ><Plus className="mr-2 h-4 w-4"  />
        Add Enhance Material</Link>
