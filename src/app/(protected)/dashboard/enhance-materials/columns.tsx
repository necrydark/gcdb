...
import { deleteEnhanceMaterial } from "@/src/actions/materials";
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="bg-purple-400 text-white  dark:bg-purple-700">
            ...
            <DropdownMenuItem className="cursor-pointer rounded-[5px] dark:focus:bg-purple-900 focus:text-white focus:bg-purple-600" asChild>
              <Link href={`/dashboard/enhance-materials/edit/${material.id}`}>
                Edit
              </Link>
            </DropdownMenuItem>
            <DropdownMenuItem
            ...
            >
              <Link href={`/dashboard/enhance-materials/view/${material.id}`}
              className="w-full">
              View</Link>
            </DropdownMenuItem>
            ...
            className="dark:focus:bg-purple-900 focus:text-white rounded-[5px] focus:bg-purple-600 cursor-pointer"
              onClick={() => {
                deleteEnhanceMaterial(row.original.id);
              }}
            >
              Delete
            </DropdownMenuItem>
